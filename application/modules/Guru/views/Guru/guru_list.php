                                     ...
                                     <tbody>
                                       <?php foreach ($dataguru as $d): ?>
                                         <tr>
                                           ...
                                           <?php endforeach; ?>
                                           <td>
                                             <a href="<?php echo base_url().$module?>/guru/edit/<?php echo $d->id_guru ?>"><i class="m-1 feather icon-edit-2"></i></a>
                                             <a class="modalDelete" data-toggle="modal" data-target="#responsive-modal" value="<?php echo $d->id_guru ?>" href="#"><i class="feather icon-trash"></i></a>
                                           </td>
