      ...
      <div class="card-content">
        <div class="card-body">
          <form method="post" action="<?php echo base_url().$action ?>"><div class="form-group row">
                ...
                <label class="col-sm-2 col-form-label">jmlh_penghasilan_ayah</label>
                <div class="col-sm-10">
                  <input type="text" name="jmlh_penghasilan_ayah" class="form-control">
                </div>
              </div><div class="form-group row">
                <label class="col-sm-2 col-form-label">jmlh_penghasilan_ibu</label>
                <div class="col-sm-10">
                  <input type="text" name="jmlh_penghasilan_ibu" class="form-control">
                </div>
              </div><div class="form-group row">
                <label class="col-sm-2 col-form-label">pekerjaan_ayah</label>
                <div class="col-sm-10">
                  <input type="text" name="pekerjaan_ayah" class="form-control">
                </div>
              </div><div class="form-group row">
                <label class="col-sm-2 col-form-label">pekerjaan_ibu</label>
                <div class="col-sm-10">
                  <input type="text" name="pekerjaan_ibu" class="form-control">
                </div>
              </div><div class="form-group row">
                <label class="col-sm-2 col-form-label">agama_ayah</label>
                <div class="col-sm-10">
                  <input type="text" name="agama_ayah" class="form-control">
                </div>
              </div><div class="form-group row">
                <label class="col-sm-2 col-form-label">agama_ibu</label>
                <div class="col-sm-10">
                ...
                <label class="col-sm-2 col-form-label">pendidikan_terakhir_ayah</label>
                <div class="col-sm-10">
