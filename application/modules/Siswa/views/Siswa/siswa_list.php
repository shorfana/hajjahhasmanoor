                                     ...
                                     <tbody>
                                       <?php foreach ($datasiswa as $d): ?>
                                         <tr>
                                           ...
                                           <?php endforeach; ?>
                                           <td>
                                             <a href="<?php echo base_url().$module?>/siswa/edit/<?php echo $d->nik_siswa ?>"><i class="m-1 feather icon-edit-2"></i></a>
                                             <a class="modalDelete" data-toggle="modal" data-target="#responsive-modal" value="<?php echo $d->nik_siswa ?>" href="#"><i class="feather icon-trash"></i></a>
                                           </td>
