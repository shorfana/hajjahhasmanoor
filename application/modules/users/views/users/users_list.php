<?php if($this->session->flashdata('message')) {
                 ...
                 <div class="card">
                     <div class="card-header">
                         <h4 class="card-title">Data users</h4>
      		    		<a href="<?= site_url($module.'/users/create') ?>"><button type="button" class="btn btn-primary round waves-effect waves-light">
      	               	 Tambah Data
      	              	</button>
                      </a>
                     </div>
                                     ...
                                     <tbody>
                                       <?php foreach ($datausers as $d): ?>
                                         <tr>
                                           ...
                                           <?php endforeach; ?>
                                           <td>
                                             <a href="<?php echo base_url().$module?>/users/edit/<?php echo $d->id ?>"><i class="m-1 feather icon-edit-2"></i></a>
    ...
    <div id="responsive-modal" class="modal fade" tabindex="-1" users="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
